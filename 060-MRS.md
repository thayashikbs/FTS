...
## ---------
##                Estimate Std. Error t value  Pr(>|t|)    
## (Intercept)(S)   0.8417     0.3038  2.7706  0.005595 ** 
## x(S)            -0.0533     0.1393 -0.3826  0.702016    
...
##           Min            Q1           Med            Q3           Max 
## -1.5153667436 -0.0906543185  0.0001873641  0.1656717258  1.2020898977 
## 
## Regime 2 
## ---------
##                Estimate Std. Error t value  Pr(>|t|)    
## (Intercept)(S)   8.6393     0.7308 11.8217 < 2.2e-16 ***
## x(S)             1.8771     0.3108  6.0396 1.545e-09 ***
## y_1(S)          -0.0569     0.0804 -0.7077    0.4791    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
