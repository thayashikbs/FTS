...
```
## Q(m) of squared series(LM test):  
## Test statistic:  5.579901  p-value:  0.8492377 
## Rank-based Test:  
## Test statistic:  7.810757  p-value:  0.6473158 
## Q_k(m) of squared series:  
## Test statistic:  235.6601  p-value:  0.7336934 
## Robust Test(5%) :  293.216  p-value:  0.03138898
```
...
## Orthogonal Matrix U:
##            [,1]       [,2]       [,3]
## [1,] -0.4516545  0.8105171 -0.3729212
## [2,]  0.3542032  0.5465251  0.7588480
## [3,] -0.8188701 -0.2106473  0.5339283
## 
## Linear Map Z:
##             [,1]        [,2]         [,3]
## [1,] -0.03043971 0.062103014 -0.008800316
## [2,] -0.00572454 0.031103473  0.030340189
## [3,] -0.04692348 0.001079596  0.040015524
## 
## Estimated GARCH coefficients:
##         omega    alpha1     beta1
## y1 0.06995161 0.1137451 0.7902606
## y2 0.92721203 0.1177425 0.7549080
## y3 0.14757653 0.1135935 0.8082723
## 
...
## Test results:  
## Q(m) of et: 
## Test and p-value:  32.89057 0.0002841619 
## Rank-based test: 
## Test and p-value:  22.77381 0.01161299 
## Qk(m) of epsilon_t: 
## Test and p-value:  179.4081 6.693057e-08 
## Robust Qk(m):  
## Test and p-value:  162.5182 4.423408e-06
```
...
```
##           [,1]      [,2]      [,3]
## [1,] 1.0000000 0.1066579 0.1652736
## [2,] 0.1066579 1.0000000 0.3544019
## [3,] 0.1652736 0.3544019 1.0000000
```
