...
## ---------
##                Estimate Std. Error t value  Pr(>|t|)    
## (Intercept)(S)   0.8417     0.3034  2.7742  0.005534 ** 
## x(S)            -0.0533     0.1372 -0.3885  0.697646    
...
##           Min            Q1           Med            Q3           Max 
## -1.5153667395 -0.0906543191  0.0001873641  0.1656717257  1.2020898977 
## 
## Regime 2 
## ---------
##                Estimate Std. Error t value  Pr(>|t|)    
## (Intercept)(S)   8.6393     0.7321 11.8007 < 2.2e-16 ***
## x(S)             1.8771     0.3108  6.0396 1.545e-09 ***
## y_1(S)          -0.0569     0.0806 -0.7060    0.4802    
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
