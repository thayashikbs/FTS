...
```
## Q(m) of squared series(LM test):  
## Test statistic:  6.826281  p-value:  0.741737 
## Rank-based Test:  
## Test statistic:  11.84481  p-value:  0.2955771 
## Q_k(m) of squared series:  
## Test statistic:  244.0262  p-value:  0.5946158 
## Robust Test(5%) :  272.2414  p-value:  0.1595723
```
...
## Orthogonal Matrix U:
##            [,1]       [,2]       [,3]
## [1,] -0.4534575  0.3722297  0.8098280
## [2,]  0.3540761 -0.7586033  0.5469472
## [3,] -0.8179281 -0.5347580 -0.2121967
## 
## Linear Map Z:
##              [,1]         [,2]        [,3]
## [1,] -0.030556529  0.008751841 0.062052474
## [2,] -0.005745581 -0.030354179 0.031085939
## [3,] -0.046882081 -0.040066373 0.000988435
## 
## Estimated GARCH coefficients:
##         omega     alpha1     beta1
## y1 0.02706141 0.10518768 0.8641966
## y2 0.11491890 0.09773037 0.8322256
## y3 0.38618727 0.17005012 0.6787194
## 
...
## Test results:  
## Q(m) of et: 
## Test and p-value:  18.88785 0.04171045 
## Rank-based test: 
## Test and p-value:  16.68676 0.08158891 
## Qk(m) of epsilon_t: 
## Test and p-value:  167.828 1.237766e-06 
## Robust Qk(m):  
## Test and p-value:  128.289 0.005008534
```
...
```
##           [,1]      [,2]      [,3]
## [1,] 1.0000000 0.1664470 0.1067859
## [2,] 0.1664470 1.0000000 0.3539051
## [3,] 0.1067859 0.3539051 1.0000000
```
